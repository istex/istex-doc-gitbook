...
Vous remarquez que l'[OpenURL de l'API ISTEX](../../api-istex/openurl-1.0/) est appelée en AJAX en interrogeant le DOI :
...
* [Archive ouverte HAL](../ils-ont-integre-istex/cnrs-ccsd.md)
* [CHU Rouen](../ils-ont-integre-istex/chu-rouen-normandie.md)
* [Université Aix Marseille](../ils-ont-integre-istex/universite-aix-marseille.md) =&gt; [Code source disponible sur GitHub](https://github.com/SCD-Aix-Marseille-Universite/SMASH/blob/master/resolver.js#L726-L746)
* [Université de Jean Monnet St Etienne](../ils-ont-integre-istex/universite-jean-monnet-st-etienne.md)
* [Université de Paris Saclay](../ils-ont-integre-istex/universite-paris-saclay.md) =&gt;[Code source disponible sur GitHub](https://github.com/istex/istex-button-primo)
