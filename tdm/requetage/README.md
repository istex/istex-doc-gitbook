...
[https://api.istex.fr/document/?q=host.title:"Biofutur"OR host.issn:"0294-3506"AND(host.publicationDate:1995 AND author.name:"DODET")\&output=title,author,host\&size=100](https://api.istex.fr/document?q=host.title%3A%22Biofutur%22+OR+host.issn%3A%220294-3506%22+AND+%28publicationDate%3A1995+AND+author.name%3A%22Dodet%22%29\&output=title,author,host\&size=100)
