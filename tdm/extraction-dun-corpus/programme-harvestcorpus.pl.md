...
* **Avantages** :
  ...
  * Il vérifie le type des fichiers déchargés, signale les problèmes d'authentification et relance le déchargement des fichiers concernés \(pour plus de détails, voir la rubrique Détecter les problèmes d'authentification dans le chapitre [**Vérification et la mise en forme des résultats**](https://doc.istex.fr/tdm/verification/README.md)\). 
* **Inconvénients** :
